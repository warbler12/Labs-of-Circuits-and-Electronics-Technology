...
entity FSM_logic is
    Port ( clk : in STD_LOGIC;
           ...
           w : in STD_LOGIC;
           z : out STD_LOGIC;
           y : buffer STD_LOGIC_VECTOR(8 downto 0) := "000000001";
...
begin
    ...
    begin
		if rising_edge(clk) then
			...
			y(5) <= (y(0) or y(1) or y(2) or y(3) or y(4))and w and reset; --F
			y(4) <= (y(3) or y(4)) and not w and reset; --E
			y(3) <= y(2) and not w and reset; --D
			y(2) <= y(1) and not w and reset; --C
			y(1) <= (y(0) or y(5) or y(6) or y(7) or y(8))and not w and reset; --B
			y(0) <= not reset; --A
		end if;
    end process;
